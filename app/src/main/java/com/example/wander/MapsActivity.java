...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clp = new LatLng(-7.678830, 109.023390);
        mMap.addMarker(new MarkerOptions().position(clp).title("Marker in Alun-Alun Cilacap").snippet("I am here now!"));
        float zoom = 13;
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(clp,zoom));
